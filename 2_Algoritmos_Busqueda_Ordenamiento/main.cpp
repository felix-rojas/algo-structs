...
template <class T> string arrayToString(const vector<T> &v) {
  stringstream aux;
...
int main(int argc, char *argv[]) {
  ...
  int array1[] = {58, 92, 75, 5,  21, 92, 84, 91, 64, 54,
                  3,  28, 11, 61, 65, 4,  1,  8,  52, 78};
  ...
  vector<int> prueba;
  Sorts<int> sorts;
  string resp1 = "[1, 3, 4, 5, 8, 11, 21, 28, 52, 54, 58, 61, 64, 65, 75, 78, "
                 "84, 91, 92, 92]";
  ...
  cout << "\n"
       << "7.- esperada " << 5 << " programa "
       << sorts.busqSecuencial(prueba, 897) << "\n";
  cout << (5 == sorts.busqSecuencial(prueba, 897) ? "success\n" : "fail\n");

  cout << "\n"
       << "8.- esperada " << -1 << " programa "
       << sorts.busqSecuencial(prueba, 100) << "\n";
  ...
  cout << "\n"
       << "10.- esperada " << -1 << " programa "
       << sorts.busqBinaria(prueba, 197) << "\n";
