...
template <class T> std::string arrayToString(const std::vector<T> &v) {
...
template <class T> std::string listToString(const std::list<T> &v) {
...
public:
  void runTest() {
    ...
    int array[] = {58, 92, 75, 5,  21, 92, 84, 91, 64, 54,
    ...
    std::cout << "Test 1...";
    ASSERT_TRUE(!strcmp("[1, 3, 4, 5, 8, 11, 21, 28, 52, 54, 58, 61, 64, 65, "
                        "75, 78, 84, 91, 92, 92]",
